...
<div class="content">
    ...
    <div id="about-text"><p>Tamberlane is written, drawn, and maintained by Caytlin Vilbrandt.</p>
        ...
        <p>Monetary support of Tamberlane goes toward our rent and bills, purchasing merchandise to sell in the shop,
            ...
            Patreon grows, I hope to hire some talented folks to help me with the actual production of the comic so that
            I can get pages out faster.</p>
        ...
        <div id="support-buttons">
            ...
            <p>However, money is far from the only way to support Tamberlane! Sharing the comic with your friends is the
            number one way to help out. Comments, words of support, fanart and other fanworks, and even just speculating
            on the story are wonderful, wonderful things that help keep me going when the creative fuel tank is low.</p>

            <p>Thank you from the bottom of my heart for all the patience and support you've lent me over the years. You
                guys rock!</p>
